...
may explicitly request a send. Separately, set `COLLEAGUE_WEEKLY_SUMMARY_TO` to
...
most one complete summary in any seven-day period. If one delivery fails, the summary
